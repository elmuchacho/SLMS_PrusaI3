...
#define CUSTOM_MACHINE_NAME "SLMS I3"
...
#define DEFAULT_bedKp 353.32
#define DEFAULT_bedKi 69.56
#define DEFAULT_bedKd 448.67
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.30   // Z offset: -below +above  [the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS + 10), 5 }
